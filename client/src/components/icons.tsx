/**
 * The project's icon set. Stroke icons on a 24x24 grid, drawn in
 * `currentColor` so they inherit from whatever they sit in.
 *
 * Hand-rolled rather than pulled from an icon package: this is the complete
 * set the UI needs, and it keeps the bundle free of a few thousand unused
 * glyphs. `Sparkles` is the AI marker and should only appear on surfaces that
 * involve a model.
 */
...
/** The AI marker. Purple, and only on surfaces that invoke a model. */
...
export const IconGoogle = ({ size = 20, ...props }: IconProps) => (
  ...
  >
    ...
    <path
      fill="#FBBC05"
      d="M5.2 14.3a7.4 7.4 0 0 1 0-4.6l-4-3a12 12 0 0 0 0 10.6l4-3Z"
    />
    <path
      fill="#EA4335"
      d="M12 4.8c2.3 0 3.8 1 4.7 1.8l3.4-3.3A12 12 0 0 0 1.3 6.7l3.9 3c1-2.9 3.6-5 6.8-5Z"
    />
  </svg>
);
