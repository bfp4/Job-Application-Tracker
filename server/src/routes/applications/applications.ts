...
import { generateResumeTips } from "../../services/agents/resumeTips/resumeTips";
import {
  generateTailoredResume,
  isTailoredResumeContent,
} from "../../services/agents/tailoredResume/tailoredResume";
import {
  generateCoverLetter,
  isCoverLetterContent,
  type CoverLetterContent,
} from "../../services/agents/coverLetter/coverLetter";
import { renderTailoredResumePdf } from "../../lib/resumeRender/resumeRender";
import { renderCoverLetterPdf } from "../../lib/coverLetterRender/coverLetterRender";
 ...
 * disable the regenerate button (see services/agents/linkedinMessage.ts).
 *
