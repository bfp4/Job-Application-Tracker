...
vi.mock("../../services/agents/tailoredResume/tailoredResume", async (importOriginal) => ({
  ...(await importOriginal<typeof import("../../services/agents/tailoredResume/tailoredResume")>()),
