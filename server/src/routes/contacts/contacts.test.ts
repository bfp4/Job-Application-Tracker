...
vi.mock("../../services/agents/linkedinMessage/linkedinMessage", async (importOriginal) => ({
  ...(await importOriginal<typeof import("../../services/agents/linkedinMessage/linkedinMessage")>()),
...
import applicationsRouter from "../applications/applications";
